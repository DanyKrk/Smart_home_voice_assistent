...
add_device(home_dict, "lamp", "kitchen", "above the cabinets", ["on", "off", "toggle", "brightness"])
...
add_device(home_dict, "lamp", "salon", "right wall", ["on", "off", "toggle", "brightness"])
add_device(home_dict, "lamp", "salon", "left wall", ["on", "off", "toggle", "brightness"])
add_device(home_dict, "lamp", "salon", "ceiling", ["on", "off", "toggle", "brightness"])
add_device(home_dict, "lamp", "staircase", "right wall", ["on", "off", "toggle", "brightness"])
add_device(home_dict, "lamp", "staircase", "left wall", ["on", "off", "toggle", "brightness"])
